    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Library.Infrastructure.Data.Context.LibraryDbContext>
    {
        ...
        protected override void Seed(Library.Infrastructure.Data.Context.LibraryDbContext context)
        {
            ...
            var books = new List<Book>
            {
                ...
                new Book("Quincas Borba", "Continuação de 'Memórias Póstumas de Brás Cubas', o livro explora a vida de Quincas Borba, personagem secundário do romance anterior.", "978-8520913297", BookLanguageEnum.Portuguese, new DateTime(1891, 1, 1), authors[18], publishers[1]),
